...
exports.getCheese = function (req, res) {
  Cheese.find({ userId: req.user._id, _id: req.params.cheese_id }, function (
    err,
    cheese
  ) {
    if (err) res.send(err)
...
exports.putCheese = function (req, res) {
  Cheese.update(
    { userId: req.user._id, _id: req.params.cheese_id },
...
exports.deleteCheese = function (req, res) {
  Cheese.remove({ userId: req.user._id, _id: req.params.cheese_id }, function (
    err
  ) {
    if (err) res.send(err)
